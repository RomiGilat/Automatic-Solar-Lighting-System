...
//--------------------------------------current code in esp with wifi only-------------------------------------------------------//
...
//     ESP_LOGI("UART", "ESP32 is running!");
...
// Send test data to Firebase Realtime Database
    send_to_firebase("test/data", "{\"message\":\"Hello from Automatic Solar Lighting System's Microcontroller\"}");
