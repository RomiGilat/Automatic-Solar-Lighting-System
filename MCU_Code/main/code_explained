...
- Motion Sensors (PIR or UART-based)  
- **ESP-IDF Framework** (for building firmware)  
- Firebase Account *(if using Firebase integration)*  

### 🛠 **Installation**
1. Clone this repository:  
   ```sh
   git clone https://github.com/yourusername/esp32-motion-lights.git
   cd esp32-motion-lights
   ```
